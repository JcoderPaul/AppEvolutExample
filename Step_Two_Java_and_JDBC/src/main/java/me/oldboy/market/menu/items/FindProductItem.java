...
public class FindProductItem {
     ...
     * выводит меню для выбора способа поиска товара.
     *
    ...
    private void findByCategoryAndIdChoice(Scanner scanner) {
        ...
        Long inputId = InputValidator.longValidator(scanner);
        viewProductController.findProductByCategoryAndId(inputCategory, inputId);
    }
    ...
    private void findByBrandAndIdChoice(Scanner scanner) {
        ...
        viewProductController.findProductByBrandAndId(inputBrand, inputProductId);
    }
    ...
    private void findByBrandAndNameChoice(Scanner scanner) {
        ...
        viewProductController.findProductByBrandAndName(inputBrand, prodName);
    }
    ...
    private void findAllProductByBrandChoice(Scanner scanner) {
        ...
        viewProductController.findProductByBrand(inputBrand);
    }
    ...
    private void findAllProductByCategoryChoice(Scanner scanner) {
        ...
        viewProductController.findProductByCategory(inputCategory);
    }
}