...
public class UpdateProductItem {
     ...
     *
     * @param email   электронный адрес пользователя, который обновляет продукт (для целей аудита)
     ...
     *
     * @param email   электронный адрес пользователя, который обновляет товар (для целей аудита)
    ...
    private Product selectProductForUpdate(String email, Scanner scanner) {
        ...
        Product updatedData = Product.builder()
                ...
                .name(productName)
                .price(inputPrice)
                .categoryId(forUpdateProduct.getCategoryId())
                .brandId(forUpdateProduct.getBrandId())
                .description(description)
                .stockQuantity(inputStockQuantity)
                .creationAt(forUpdateProduct.getCreationAt())
