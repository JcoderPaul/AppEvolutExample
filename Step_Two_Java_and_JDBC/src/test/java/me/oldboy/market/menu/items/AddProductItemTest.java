...
class AddProductItemTest {
    ...
    void testSubMenu_SuccessfulProductCreation_Test() {
        ...
        when(brandRepository.findById(anyInt())).thenReturn(Optional.of(mockBrand));
        ...
        assertThat(mockCategory.getId()).isEqualTo(result.getCategoryId());
        assertThat(mockBrand.getId()).isEqualTo(result.getBrandId());
