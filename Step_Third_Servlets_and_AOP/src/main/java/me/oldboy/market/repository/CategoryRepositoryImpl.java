...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    public Optional<Category> create(Category entityWithNoId) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "creating category", connection);
        } finally {
    ...
    public Optional<Category> findById(Integer entityId) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "finding category by id", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
    ...
    public boolean update(Category updateData) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "updating category", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
        return isUpdated;
    ...
    public boolean delete(Integer entityId) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "deleting category", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
        return isDeleted;
    ...
    public List<Category> findAll() {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "finding all categories", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
        return findAll;
    ...
    public Optional<Category> findByName(String categoryName) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "finding category by name", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
        return Optional.ofNullable(foundCategory);
