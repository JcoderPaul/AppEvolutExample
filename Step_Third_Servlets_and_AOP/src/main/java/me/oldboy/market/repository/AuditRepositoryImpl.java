 ...
 *
 * @see me.oldboy.market.repository.interfaces.AuditRepository
 * @see Audit
 * @see Action
 * @see Status
 */
@Slf4j
@AllArgsConstructor
public class AuditRepositoryImpl implements me.oldboy.market.repository.interfaces.AuditRepository {
    /**
    ...
    public Optional<Audit> create(Audit entityWithNoId) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "creating audit record", connection);
        } finally {
    ...
    public Optional<Audit> findById(Long entityId) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "finding audit record by id", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
    ...
    public boolean update(Audit updateData) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "updating audit record", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
        return isUpdated;
    ...
    public boolean delete(Long entityId) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "deleting audit record", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
        return isDeleted;
    ...
    public List<Audit> findAll() {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "finding all audit records", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
        return findAll;
    ...
    public Optional<List<Audit>> findByCreationUserEmail(String email) {
        ...
        try {
            ...
            ConnectionRollbackHandler.handle(sqlException, "finding audit record by user email", connection);
        } finally {
            ConnectionCloseHandler.handle(connection);
        }
