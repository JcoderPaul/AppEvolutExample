...
public class ViewProductController {
    ...
    public void findProductByCategoryAndId(Category category, Long productId) {
        ...
        System.out.println(productService.findProductByCategoryAndId(category, productId));
        System.out.println("-----------------------------------------------------------------------------");
    }
    ...
    public void findProductByBrandAndId(Brand brand, Long productId) {
        ...
        System.out.println(productService.findProductByBrandAndId(brand, productId));
        System.out.println("-----------------------------------------------------------------------------");
    }
    ...
    public void findProductByBrandAndName(Brand brand, String name) {
        ...
        System.out.println(productService.findProductByBrandAndName(brand, name));
        System.out.println("-----------------------------------------------------------------------------");
    }
    ...
    public List<Product> findProductByCategory(Category category) {
        ...
        productService.findProductByCategory(category).forEach(System.out::println);
        System.out.println("-----------------------------------------------------------------------------");
    ...
    public List<Product> findProductByBrand(Brand brand) {
        ...
        productService.findProductByBrand(brand).forEach(System.out::println);
        System.out.println("-----------------------------------------------------------------------------");
